...
public class CalendarPickerView extends ListView {
    ...
    private class MonthAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            monthView.setEvents(this.events);
    ...
    List<List<MonthCellDescriptor>> getMonthCells(MonthDescriptor month, Calendar startCal) {
        ...
        while ((cal.get(MONTH) < month.getMonth() + 1 || cal.get(YEAR) < month.getYear()) //
            ...
            for (int c = 0; c < 7; c++) {
                ...
                MonthCellDescriptor monthDescriptor = new MonthCellDescriptor(date, isCurrentMonth
                        , isSelectable, isSelected, isToday, value,
                        rangeState);

                if (events != null) {
                    if (events.get(date.getTime()) != null) {
                        monthDescriptor.setEvent(events.get(date.getTime()));
                    }
                }
