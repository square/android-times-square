...
public class MonthView extends LinearLayout {
    ...
    public static MonthView create(ViewGroup parent, LayoutInflater inflater,
                                   ...
                                   int dayBackgroundResId, int dayTextColorResId, int titleTextColor, boolean displayHeader, boolean drawCellDivider,
                                   int headerTextColor, Locale locale) {
        return create(parent, inflater, weekdayNameFormat, listener, today, dividerColor,
                dayBackgroundResId, dayTextColorResId, titleTextColor, displayHeader, drawCellDivider, headerTextColor, null,
                locale);
    }
    ...
    public static MonthView create(ViewGroup parent, LayoutInflater inflater,
        ...
        view.setDrawCellDivider(drawCellDivider);
    ...
    public void setDrawCellDivider(boolean drawCellDivider) {
        grid.setDrawCellDivider(drawCellDivider);
    }
