...
public class CalendarPickerView extends ListView {
    ...
    private boolean displayCellDivider;
    ...
    public CalendarPickerView(Context context, AttributeSet attrs) {
        ...
        headerTextColor = a.getColor(R.styleable.CalendarPickerView_tsquare_headerTextColor,
                res.getColor(R.color.calendar_text_active));
        displayCellDivider = a.getBoolean(R.styleable.CalendarPickerView_tsquare_displayCellDivider, true);
    ...
    private boolean doSelectDate(Date date, MonthCellDescriptor cell) {
        ...
        if (date != null) {
            ...
            Collections.sort(selectedCells, new Comparator<MonthCellDescriptor>() {
                public int compare(MonthCellDescriptor cal1, MonthCellDescriptor cal2) {
                    long long1 = cal1.getDate().getTime();
                    long long2 = cal2.getDate().getTime();
                    if (long1 < long2) {
                        return -1;
                    }
            ...
            Collections.sort(selectedCals, new Comparator<Calendar>() {
    ...
    private void removeEnddate() {
        ...
        MonthCellDescriptor firstCell = selectedCells.get(0);
            ...
            if (monthView == null) {
                monthView =
                        MonthView.create(parent, inflater, weekdayNameFormat, listener, today, dividerColor,
                                dayBackgroundResId, dayTextColorResId, titleTextColor, displayHeader, displayCellDivider,
